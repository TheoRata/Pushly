        ...
        >
          ...
          >
            <template #default="{ item: comp }">
              <div
                class="flex items-center gap-3 px-4 pl-11 h-[36px] cursor-pointer transition-colors"
                style="transition: background 0.15s;"
                @mouseover="(e) => e.currentTarget.style.background = 'var(--glass-bg-hover)'"
                @mouseleave="(e) => e.currentTarget.style.background = 'transparent'"
              ...
              >
                <span
                  ...
                  :class="isSelected(comp) ? 'bg-[var(--color-primary)] border-[var(--color-primary)]' : 'border-[var(--glass-border-hover)]'"
                >
          ...
          <template v-else>
            <div
              ...
              class="flex items-center gap-3 px-4 pl-11 py-2 cursor-pointer transition-colors"
              style="transition: background 0.15s;"
              @mouseover="(e) => e.currentTarget.style.background = 'var(--glass-bg-hover)'"
              @mouseleave="(e) => e.currentTarget.style.background = 'transparent'"
              @click="toggleComponent(comp)"
